...
@Client.on_message(
    command(["stop", f"stop@{BOT_USERNAME}", "end", f"نهاء", "انهاء", "اسكت", "ٲسكت"])
    & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["pause", f"pause@{BOT_USERNAME}", "vpause", "ايقاف مؤقت", "ايقاف"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["resume", f"resume@{BOT_USERNAME}", "vresume", "كمل", "استكمال", "استئناف"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["unmute", f"unmute@{BOT_USERNAME}", "vunmute", "فك الميوت", "شيل الميوت"]) & other_filters
)
@authorized_users_only
