            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/Scolze_WA",
                    )
                ],
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/f35c68b2ee6108b876731.jpg",
        caption=f"""ᴘʀᴏɢʀᴀᴍᴍᴇʀ [𝘿𝘼𝘿 𝙎𝘾𝙊𝙇𝙕𝙀](https://t.me/Scolze_WA) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/ScolzeMusic_bot?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("• 𝘿𝘼𝘿 𝙎𝘾𝙊𝙇𝙕𝙀 ᵛ͢ᵎᵖ ", url=f"https://t.me/Scolze_WA"),
            ],
            [
                InlineKeyboardButton(
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        url=f'https://t.me/ScolzeMusic_bot?startgroup=true'),
                        ],
                    ]
                )
            )
